...
<dialog ref={advertisementRef} className='half-black-backdrop sm:min-h-[80vh] sm:w-[80vw] lg:w-[30vw] p-0 bg-transparent'>
    {/* <div className=''> */}
        <div className='relative flex flex-col items-center justify-center p-0 bg-transparent aspect-[9/16] h-[80vh] mx-auto'>
